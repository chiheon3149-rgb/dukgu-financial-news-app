    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-end gap-1.5">
          ...
          {sortBy === "views" && (
            <div className="flex items-center bg-white p-0.5 rounded-lg border border-slate-200 mr-auto animate-in slide-in-from-top-2 fade-in duration-300">
          ...
          <button
            ...
            onClick={refresh}
            disabled={isLoading}
            className="p-2 bg-white rounded-lg border border-slate-200 text-slate-500 hover:text-emerald-500 transition-all active:rotate-180 duration-500 disabled:opacity-30"
          >
            <RefreshCw
